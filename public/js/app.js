(function () {
  ...
  */
  ...
  // src/js/containers/price.coffee
  ...
  var Price = (function(superClass) {
    extend$4(Price, superClass);

    function Price() {
      return Price.__super__.constructor.apply(this, arguments);
    }

    Price.prototype.tag = 'price';

    Price.prototype.subscribe = true;

    Price.prototype.init = function() {
      return Price.__super__.init.apply(this, arguments);
    };

    Price.prototype.subscription = function() {
      this.subscribe = true;
      return this.scheduleUpdate();
    };

    Price.prototype.onetime = function() {
  ...
  // src/js/containers/gallery.coffee
  ...
  var Gallery = (function(superClass) {
    extend$5(Gallery, superClass);

    function Gallery() {
      return Gallery.__super__.constructor.apply(this, arguments);
    }

    Gallery.prototype.tag = 'gallery';

    Gallery.prototype.current = 0;

    Gallery.prototype.total = 0;

    Gallery.prototype.init = function() {
      this.current = parseInt(this.current, 10);
      this.total = parseInt(this.total, 10);
      return Gallery.__super__.init.apply(this, arguments);
    };

    Gallery.prototype.last = function() {
      this.current = (this.total + this.current - 1) % this.total;
      return this.scheduleUpdate();
    };
    ...
    Gallery.prototype.jump = function(n) {
      return function() {
          ...
          if ((xhr.status >= 200 && xhr.status < 300) || xhr.status == 304 || (xhr.status == 0 && protocol == 'file:')) {
            ...
            if (xhr.responseType == 'arraybuffer' || xhr.responseType == 'blob')
              ...
              try {
                ...
                if (dataType == 'script')    (0, eval)(result);
  ...
  // node_modules/astley.js/src/zepto.coffee

  // node_modules/astley.js/src/header-menu.coffee
  ...
  // node_modules/astley.js/src/header-menu-complex.coffee
  ...
  HeaderMenuComplex = (function(superClass) {
    extend$6(HeaderMenuComplex, superClass);
  ...
  // node_modules/astley.js/src/header-menu-mobile.coffee
  ...
  HeaderMenuMobile = (function(superClass) {
    extend$7(HeaderMenuMobile, superClass);
  ...
  // node_modules/astley.js/src/header-menu-simple.coffee
  ...
  HeaderMenuSimple = (function(superClass) {
    extend$8(HeaderMenuSimple, superClass);
  ...
  // node_modules/astley.js/src/privacy-popup.coffee
  var PrivacyPopup,
  ...
  PrivacyPopup = (function(superClass) {
    extend$9(PrivacyPopup, superClass);
  ...
  */
  ...
  // node_modules/astley.js/src/utils.coffee
  var debounce;
  ...
  // node_modules/astley.js/src/_content-annotator.coffee
  ...
  // node_modules/astley.js/src/hero.coffee
  var Hero,
  ...
  // node_modules/astley.js/src/block.coffee
  var Block,
    extend$b = function(child, parent) { for (var key in parent) { if (hasProp$a.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$a = {}.hasOwnProperty;

  Block = (function(superClass) {
    extend$b(Block, superClass);
  ...
  // node_modules/astley.js/src/cta.coffee
  var CTA,
    extend$c = function(child, parent) { for (var key in parent) { if (hasProp$b.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$b = {}.hasOwnProperty;

  CTA = (function(superClass) {
    extend$c(CTA, superClass);
  ...
  // node_modules/astley.js/src/animate.coffee
  var triggerDist;
  ...
  // node_modules/astley.js/src/index.coffee
  var start, tagNames;
  ...
  var init = start = function(orgId) {
    ...
    return El$1$1.mount(tagNames.join(','));
  };

  // src/js/astley.coffee
